    ...
    <div class="container w3-animate-opacity">
	  ...
	  <main id="chat" class="texts">
	      <div class="message-container">
			 ...
			 <p>To have a voice conversation, first click "Start Voicechat", then allow access to your mic and then... just say hello.<br>
			 Please note: Voicechat works well on Mac, but it's unstable on Windows and on Android.</p>
			 
			 Ziggy is now powered by <a href="https://llama.meta.com/llama3/" target="_blank">Llama3 70b</a><br> 
			 running on <a href="https://wow.groq.com/why-groq/" target="_blank">GroqCloud</a>.
